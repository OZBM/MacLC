...
// video pane - HDR / EDR box
@property (readwrite, weak) IBOutlet NSBox *video_hdrBox;
@property (readwrite, weak) IBOutlet NSTextField *video_hdrModeLabel;
@property (readwrite, weak) IBOutlet NSPopUpButton *video_hdrModePopup;
