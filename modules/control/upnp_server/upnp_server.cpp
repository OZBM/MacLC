...
static xml::Document make_server_identity(const char *uuid, const char *server_name)
{
    ...
    xml::Element root = ret.create_element(
        ...
        ret.create_element(
            ...
            ret.create_element("manufacturer", ret.create_text_node("Hazen Studio")),
            ret.create_element("manufacturerURL", ret.create_text_node("https://www.hazenstudio.com")),
            ret.create_element("modelDescription", ret.create_text_node("MacLC UPnP Media Server")),
            ret.create_element("modelName", ret.create_text_node("MacLC")),
            ret.create_element("modelNumber", ret.create_text_node(PACKAGE_VERSION)),
            ret.create_element("modelURL", ret.create_text_node("https://www.hazenstudio.com")),
