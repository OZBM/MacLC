...
# Without contribs there is no Frameworks directory to link to, and the
# build tree may already carry a real one, so skip that link.
pseudo-bundle:
	...
	test -z "$(CONTRIB_DIR)" || $(LN_S) -nf $(CONTRIB_DIR)/Frameworks
